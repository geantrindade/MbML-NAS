...
def main(base_dir, id_run, n_e, seed, train_size):
    ...
    dataset_test = Nb101Dataset(split=args.eval_split, exclude_split=train_split_seed)
...
if __name__ == "__main__":
    ...
    train_sizes = ['43', '86', '129', '172', '334', '860']
    id_run = 0
    ...
    for n_e in epochs:
        for seed in seeds:
            for train_size in train_sizes:
                ...
                main(base_dir, run_dir_name, n_e, seed, train_size)
                print('\n=======================================\n')
